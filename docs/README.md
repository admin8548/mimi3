...
本目录按文档用途分层，避免所有资料都堆在 `docs/fixes/`。

## 目录结构

| 目录 | 用途 |
|---|---|
| `docs/protocol/` | OpenClaw 协议研究、字段字典、能力矩阵、扩展路线图 |
| `docs/guides/` | 可复用操作指南、运行时闭环分析方法 |
| `docs/incidents/` | 事故分析、问题复盘、故障交接 |
| `docs/fixes/` | 代码修复、主线稳定性推进记录、较短修复总结 |

## 推荐阅读顺序

1. `docs/protocol/openclaw_protocol_final_report.md`
2. `docs/protocol/openclaw_protocol_field_dictionary.md`
